...
in
{
  "@gotrade/semantic-generator" = nodeEnv.buildNodePackage {
    name = "_at_gotrade_slash_semantic-generator";
    packageName = "@gotrade/semantic-generator";
    version = "0.7.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@gotrade/semantic-generator/-/semantic-generator-0.7.1.tgz";
      sha512 = "/ty//XC9gy8c+YvF2jfLfYSpVqDHQrYbCczH5CAWd9yRJtFw60xsS/lGJ9Z/bZx2kNcYvyHOv7aYPK1p/1xARQ==";
    };
    dependencies = [
